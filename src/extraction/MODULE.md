...
- `PDFExtractor` — class — pub — Extract text blocks, tables, and images from PDF files.
  ...
  - `_make_group` — staticmethod — internal — Create a font group from collected texts and a representative segment.
...
- `infer_metadata_from_path` — function — pub — Infer mno, release, and doc_type from folder structure.
