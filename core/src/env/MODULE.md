...
- `_truthy` — function — internal — Treat env-var strings as bool.
...
- `LLMConfigFile` — dataclass — pub — Schema for `config/llm.
...
- `resolve_grouping_enabled` — function — pub — Resolve whether Stage 4.
...
- `RetrievalConfig` — dataclass — pub — Schema for `config/retrieval.
  - `load` — classmethod — pub
