...
- `GenericStructuralParser` — class — pub — Profile-driven structural parser for requirement documents.
  ...
  - `_extract_definitions` — method — internal — FR-35 [D-032]: extract `term -> expansion` pairs and the section number of the glossary section.
