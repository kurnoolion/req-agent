...
- Requirement IDs may follow any scheme ("REQ-NNN", "<PLAN0>_R042", "[V-001]", or none at all). If the documents enumerate requirements without a stable label format, leave requirement_id.pattern as empty string and the parser will fall back to section-number anchoring.
